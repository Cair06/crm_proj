# Generated by Django 4.1.1 on 2022-09-06 10:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('manufacter', models.TextField(verbose_name='Производитель')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_id', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='orders_app.customer', verbose_name='Идетификатор пользователя')),
            ],
            options={
